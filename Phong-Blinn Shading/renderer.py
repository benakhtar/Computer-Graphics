...
class Renderer:
    ...
    def render(self, shading, bg_color, ambient_light):
        ...
        for self.mesh in self.meshes:
            ...
            verts_normals = [Vector(self.mesh.transform.apply_to_normal(normal.to_array())) for normal in self.mesh.vertex_normals]
            verts_normals =[]
                            ...
                            if shading == "depth":
                                ...
                                if z > self.z_buffer[x, y] and out_of_depth == False:
                                    ...
                                    if shading == "phong-blinn":
                                        ...
                                        # forgot this normal needs to be reset - BEN NOTE
